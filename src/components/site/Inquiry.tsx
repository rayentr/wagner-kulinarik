...
export function Inquiry() {
  ...
  const burst = (origin: HTMLElement) => {
    ...
    for (let i = 0; i < 6; i++) {
      ...
      crumb.style.cssText = `position:fixed;left:${rect.left + rect.width / 2}px;top:${rect.top + rect.height / 2}px;width:${5 + Math.random() * 5}px;height:${5 + Math.random() * 5}px;border-radius:2px;background:var(--accent);z-index:60;pointer-events:none;`;
  ...
  const chip = (on: boolean) =>
    `border px-4 py-2.5 font-sans text-sm transition-colors ${
      on
  ...
  return (
    <section id="anfrage" ref={root} className="bg-paper text-ink">
      <div
        className="relative aspect-[16/9] max-h-[42svh] min-h-[14rem] overflow-hidden bg-night-soft"
        data-cursor="media"
      >
        <AmbientVideo
      ...
      <div className="relative z-10 mx-auto -mt-24 max-w-[34rem] px-6 pb-20 md:-mt-32 md:px-0 md:pb-28">
        <div
          ref={cardRef}
          className="surface-cream origin-center px-7 py-8 shadow-[0_24px_50px_rgba(35,31,32,.08)] md:px-10 md:py-11"
        >
          {sent ? (
            <div>
            ...
            <>
              ...
              <h2 className="mt-4 font-display text-4xl font-medium leading-[.92] tracking-[-.03em] md:text-5xl">
                Ihr Abend.
              </h2>
                ...
                {step === 1 && (
                  <div data-inquiry-step>
                    ...
                    <button
                      ...
                      data-cursor="link"
                      onClick={() => goStep(0)}
                      className="mt-5 font-sans text-xs text-ink/40"
                    >
                      ← Zurück
                    </button>
                  </div>
                ...
                {step >= 3 && type && intent && (
                  <div data-inquiry-step>
                    ...
                    <button
                      ...
                      data-cursor="link"
                      onClick={() => goStep(0)}
                      className="mt-4 font-sans text-xs text-ink/40"
                    >
                      Neu legen
                    </button>
                  </div>
              ...
              {formReady && (
                ...
                >
                  ...
                  <button
                    ...
                    data-cursor="cta"
                    type="submit"
                    className="self-start bg-accent px-8 py-3.5 font-sans text-sm font-medium text-paper transition-colors duration-300 hover:bg-berry-bright"
                  >
                    {intent === "reservation"
                      ? "Den Tisch halten"
                      : "Die Karte schicken"}
